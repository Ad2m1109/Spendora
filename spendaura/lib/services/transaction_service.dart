...
class TransactionService {
  ...
  // Fetch expense categories chart
  static Future<Uint8List> getExpenseCategoriesChart(
      String userId, String token) async {
    final response = await http.post(
      Uri.parse('$baseUrl/transactions/expense-categories-chart'),
      headers: {
        'Content-Type': 'application/json',
        'Authorization': 'Bearer $token',
      },
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception('Failed to fetch expense categories chart');
    }
  }
