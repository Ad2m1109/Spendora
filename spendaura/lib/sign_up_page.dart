...
import 'package:google_sign_in/google_sign_in.dart' as g_signin; // Import for GoogleSignInAccount
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  // Conditionally instantiate GoogleSignIn
  GoogleSignIn? _googleSignIn; // Make it nullable
  ...
  Future<void> _signUpWithGoogle() async {
    if (_googleSignIn == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Google Sign-Up is not supported on this platform.')),
      );
      return;
    }
    ...
    try {
      ...
      // Get user details from Google account
            final g_signin.GoogleSignInAccount? googleAccount = _googleSignIn!.currentUser;
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 30),
                      // Conditionally display Google Sign-In button
                      if (!kIsWeb && (Platform.isAndroid || Platform.isIOS))
                        Row(
